...
#define HEN_RAI LT(_RAISE, KC_HENK)
#define MHE_LOW LT(_LOWER, KC_MHEN)
#define M_ALTPSC M(0)
...
[_QWERTY] = KEYMAP( \
  ...
  ADJUST,  KC_LCTL, KC_LALT, KC_LGUI, MHE_LOW,   KC_SPC,  KC_SPC,  HEN_RAI,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_RAISE] = KEYMAP( \
  ...
  KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_PLUS, \
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |AltPsc|PrtScr|Aud on|Audoff|AGnorm|AGswap|Qwerty|Colemk|Dvorak|      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      | Play | Stop |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      | Rwnd | Vol- | Vol+ | Ffwd |
...
[_ADJUST] =  KEYMAP( \
  ...
  _______,M_ALTPSC, KC_PSCR, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  _______, _______, \
