...
const uint16_t PROGMEM keymap_jis2us[][2] = {
    ...
    [KC_EXLM] = { KC_EXLM, KC_EXLM    },
    [KC_AT]   = { KC_LBRC, KC_LBRC    },
    [KC_HASH] = { KC_HASH, KC_HASH    },
    [KC_DLR]  = { KC_DLR,  KC_DLR     },
    [KC_PERC] = { KC_PERC, KC_PERC    },
    [KC_CIRC] = { KC_EQL,  KC_EQL     },
    [KC_AMPR] = { KC_CIRC, KC_CIRC    },
    [KC_ASTR] = { KC_DQT,  KC_DQT     },
    [KC_LPRN] = { KC_ASTR, KC_ASTR    },
    [KC_RPRN] = { KC_LPRN, KC_LPRN    },
    [KC_UNDS] = { S(KC_RO),S(KC_RO)   },
    [KC_PLUS] = { KC_COLN, KC_COLN    },
    [KC_LCBR] = { KC_RCBR, KC_RCBR    },
    [KC_RCBR] = { KC_PIPE, KC_PIPE    },
    [KC_PIPE] = { S(KC_JYEN), S(KC_JYEN) },
    [KC_COLN] = { KC_QUOT, KC_QUOT    },
    [KC_DQT]  = { KC_AT,   KC_AT      },
    [KC_TILD] = { KC_PLUS, KC_PLUS    },
};
